...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.2)", date = "2016-3-16")
public class FileSystemMasterWorkerService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
    ...
    public FileInfo getFileInfoWithBlock(long blockId) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void getFileInfoWithBlock(long blockId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public FileInfo getFileInfoWithBlock(long blockId) throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      send_getFileInfoWithBlock(blockId);
      return recv_getFileInfoWithBlock();
    }

    public void send_getFileInfoWithBlock(long blockId) throws org.apache.thrift.TException
    {
      getFileInfoWithBlock_args args = new getFileInfoWithBlock_args();
      args.setBlockId(blockId);
      sendBase("getFileInfoWithBlock", args);
    }

    public FileInfo recv_getFileInfoWithBlock() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException
    {
      getFileInfoWithBlock_result result = new getFileInfoWithBlock_result();
      receiveBase(result, "getFileInfoWithBlock");
      if (result.isSetSuccess()) {
        return result.success;
      }
      if (result.e != null) {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getFileInfoWithBlock failed: unknown result");
    }
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void getFileInfoWithBlock(long blockId, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getFileInfoWithBlock_call method_call = new getFileInfoWithBlock_call(blockId, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getFileInfoWithBlock_call extends org.apache.thrift.async.TAsyncMethodCall {
      private long blockId;
      public getFileInfoWithBlock_call(long blockId, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.blockId = blockId;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getFileInfoWithBlock", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getFileInfoWithBlock_args args = new getFileInfoWithBlock_args();
        args.setBlockId(blockId);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public FileInfo getResult() throws alluxio.thrift.AlluxioTException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getFileInfoWithBlock();
      }
    }
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getFileInfoWithBlock", new getFileInfoWithBlock());
    ...
    public static class getFileInfoWithBlock<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getFileInfoWithBlock_args> {
      public getFileInfoWithBlock() {
        super("getFileInfoWithBlock");
      }

      public getFileInfoWithBlock_args getEmptyArgsInstance() {
        return new getFileInfoWithBlock_args();
      }
      ...
      public getFileInfoWithBlock_result getResult(I iface, getFileInfoWithBlock_args args) throws org.apache.thrift.TException {
        getFileInfoWithBlock_result result = new getFileInfoWithBlock_result();
        try {
          result.success = iface.getFileInfoWithBlock(args.blockId);
        } catch (alluxio.thrift.AlluxioTException e) {
          result.e = e;
        }
        return result;
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class getFileInfoWithBlock<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getFileInfoWithBlock_args, FileInfo> {
      public getFileInfoWithBlock() {
        super("getFileInfoWithBlock");
      }
      ...
      public void start(I iface, getFileInfoWithBlock_args args, org.apache.thrift.async.AsyncMethodCallback<FileInfo> resultHandler) throws TException {
        iface.getFileInfoWithBlock(args.blockId,resultHandler);
      }
    }
  ...
  public static class getFileInfoWithBlock_args implements org.apache.thrift.TBase<getFileInfoWithBlock_args, getFileInfoWithBlock_args._Fields>, java.io.Serializable, Cloneable, Comparable<getFileInfoWithBlock_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getFileInfoWithBlock_args");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getFileInfoWithBlock_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getFileInfoWithBlock_argsTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.BLOCK_ID, new org.apache.thrift.meta_data.FieldMetaData("blockId", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getFileInfoWithBlock_args.class, metaDataMap);
    }

    public getFileInfoWithBlock_args() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getFileInfoWithBlock_args(getFileInfoWithBlock_args other) {
      __isset_bitfield = other.__isset_bitfield;
      this.blockId = other.blockId;
    }

    public getFileInfoWithBlock_args deepCopy() {
      return new getFileInfoWithBlock_args(this);
    }
     ...
     * one block id of the file
     */
    public getFileInfoWithBlock_args setBlockId(long blockId) {
      this.blockId = blockId;
      setBlockIdIsSet(true);
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getFileInfoWithBlock_args)
        return this.equals((getFileInfoWithBlock_args)that);
      return false;
    }

    public boolean equals(getFileInfoWithBlock_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getFileInfoWithBlock_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getFileInfoWithBlock_args(");
      boolean first = true;
    ...
    private static class getFileInfoWithBlock_argsStandardSchemeFactory implements SchemeFactory {
      public getFileInfoWithBlock_argsStandardScheme getScheme() {
        return new getFileInfoWithBlock_argsStandardScheme();
      }
    }

    private static class getFileInfoWithBlock_argsStandardScheme extends StandardScheme<getFileInfoWithBlock_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getFileInfoWithBlock_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getFileInfoWithBlock_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getFileInfoWithBlock_argsTupleSchemeFactory implements SchemeFactory {
      public getFileInfoWithBlock_argsTupleScheme getScheme() {
        return new getFileInfoWithBlock_argsTupleScheme();
      }
    }

    private static class getFileInfoWithBlock_argsTupleScheme extends TupleScheme<getFileInfoWithBlock_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getFileInfoWithBlock_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getFileInfoWithBlock_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.blockId = iprot.readI64();
  ...
  public static class getFileInfoWithBlock_result implements org.apache.thrift.TBase<getFileInfoWithBlock_result, getFileInfoWithBlock_result._Fields>, java.io.Serializable, Cloneable, Comparable<getFileInfoWithBlock_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getFileInfoWithBlock_result");
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getFileInfoWithBlock_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getFileInfoWithBlock_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      tmpMap.put(_Fields.E, new org.apache.thrift.meta_data.FieldMetaData("e", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getFileInfoWithBlock_result.class, metaDataMap);
    }

    public getFileInfoWithBlock_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getFileInfoWithBlock_result(getFileInfoWithBlock_result other) {
      if (other.isSetSuccess()) {
        this.success = new FileInfo(other.success);
      }
      if (other.isSetE()) {
    ...
    public getFileInfoWithBlock_result deepCopy() {
      return new getFileInfoWithBlock_result(this);
    }
    ...
    public getFileInfoWithBlock_result setSuccess(FileInfo success) {
      this.success = success;
      return this;
    }
    ...
    public getFileInfoWithBlock_result setE(alluxio.thrift.AlluxioTException e) {
      this.e = e;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getFileInfoWithBlock_result)
        return this.equals((getFileInfoWithBlock_result)that);
      return false;
    }

    public boolean equals(getFileInfoWithBlock_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(getFileInfoWithBlock_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getFileInfoWithBlock_result(");
      boolean first = true;
    ...
    private static class getFileInfoWithBlock_resultStandardSchemeFactory implements SchemeFactory {
      public getFileInfoWithBlock_resultStandardScheme getScheme() {
        return new getFileInfoWithBlock_resultStandardScheme();
      }
    }

    private static class getFileInfoWithBlock_resultStandardScheme extends StandardScheme<getFileInfoWithBlock_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getFileInfoWithBlock_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getFileInfoWithBlock_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getFileInfoWithBlock_resultTupleSchemeFactory implements SchemeFactory {
      public getFileInfoWithBlock_resultTupleScheme getScheme() {
        return new getFileInfoWithBlock_resultTupleScheme();
      }
    }

    private static class getFileInfoWithBlock_resultTupleScheme extends TupleScheme<getFileInfoWithBlock_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getFileInfoWithBlock_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getFileInfoWithBlock_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.success = new FileInfo();
