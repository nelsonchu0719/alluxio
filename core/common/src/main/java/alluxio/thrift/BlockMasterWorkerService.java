...
public class BlockMasterWorkerService {
  ...
  public interface Iface extends alluxio.thrift.AlluxioService.Iface {
     ...
     * 
     * @param oldestAccessTime the last access time for the least significant block
     */
    public alluxio.thrift.Command heartbeat(long workerId, Map<String,Long> usedBytesOnTiers, List<Long> removedBlockIds, Map<String,List<Long>> addedBlocksOnTiers, long oldestAccessTime) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface extends alluxio.thrift.AlluxioService .AsyncIface {
    ...
    public void heartbeat(long workerId, Map<String,Long> usedBytesOnTiers, List<Long> removedBlockIds, Map<String,List<Long>> addedBlocksOnTiers, long oldestAccessTime, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends alluxio.thrift.AlluxioService.Client implements Iface {
    ...
    public alluxio.thrift.Command heartbeat(long workerId, Map<String,Long> usedBytesOnTiers, List<Long> removedBlockIds, Map<String,List<Long>> addedBlocksOnTiers, long oldestAccessTime) throws org.apache.thrift.TException
    {
      send_heartbeat(workerId, usedBytesOnTiers, removedBlockIds, addedBlocksOnTiers, oldestAccessTime);
      return recv_heartbeat();
    }

    public void send_heartbeat(long workerId, Map<String,Long> usedBytesOnTiers, List<Long> removedBlockIds, Map<String,List<Long>> addedBlocksOnTiers, long oldestAccessTime) throws org.apache.thrift.TException
    {
      ...
      args.setOldestAccessTime(oldestAccessTime);
  ...
  public static class AsyncClient extends alluxio.thrift.AlluxioService.AsyncClient implements AsyncIface {
    ...
    public void heartbeat(long workerId, Map<String,Long> usedBytesOnTiers, List<Long> removedBlockIds, Map<String,List<Long>> addedBlocksOnTiers, long oldestAccessTime, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      heartbeat_call method_call = new heartbeat_call(workerId, usedBytesOnTiers, removedBlockIds, addedBlocksOnTiers, oldestAccessTime, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class heartbeat_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private long oldestAccessTime;
      public heartbeat_call(long workerId, Map<String,Long> usedBytesOnTiers, List<Long> removedBlockIds, Map<String,List<Long>> addedBlocksOnTiers, long oldestAccessTime, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.workerId = workerId;
  ...
  public static class Processor<I extends Iface> extends alluxio.thrift.AlluxioService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class heartbeat<I extends Iface> extends org.apache.thrift.ProcessFunction<I, heartbeat_args> {
      ...
      public heartbeat_result getResult(I iface, heartbeat_args args) throws org.apache.thrift.TException {
        heartbeat_result result = new heartbeat_result();
        result.success = iface.heartbeat(args.workerId, args.usedBytesOnTiers, args.removedBlockIds, args.addedBlocksOnTiers, args.oldestAccessTime);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends alluxio.thrift.AlluxioService.AsyncProcessor<I> {
    ...
    public static class heartbeat<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, heartbeat_args, alluxio.thrift.Command> {
      ...
      public void start(I iface, heartbeat_args args, org.apache.thrift.async.AsyncMethodCallback<alluxio.thrift.Command> resultHandler) throws TException {
        iface.heartbeat(args.workerId, args.usedBytesOnTiers, args.removedBlockIds, args.addedBlocksOnTiers, args.oldestAccessTime,resultHandler);
      }
    }
...
;
  ...
  public static class heartbeat_args implements org.apache.thrift.TBase<heartbeat_args, heartbeat_args._Fields>, java.io.Serializable, Cloneable, Comparable<heartbeat_args>   {
    ...
    private static final org.apache.thrift.protocol.TField OLDEST_ACCESS_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("oldestAccessTime", org.apache.thrift.protocol.TType.I64, (short)5);
    ...
    private long oldestAccessTime; // required
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
       ...
       */
      OLDEST_ACCESS_TIME((short)5, "oldestAccessTime");
    ...
    // isset id assignments
    private static final int __WORKERID_ISSET_ID = 0;
    private static final int __OLDESTACCESSTIME_ISSET_ID = 1;
    private byte __isset_bitfield = 0;
    public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      ...
      tmpMap.put(_Fields.ADDED_BLOCKS_ON_TIERS, new org.apache.thrift.meta_data.FieldMetaData("addedBlocksOnTiers", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
              ...
              new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
                  new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)))));
      tmpMap.put(_Fields.OLDEST_ACCESS_TIME, new org.apache.thrift.meta_data.FieldMetaData("oldestAccessTime", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public heartbeat_args(heartbeat_args other) {
      ...
      this.oldestAccessTime = other.oldestAccessTime;
    }
    ...
    public void clear() {
      ...
      setOldestAccessTimeIsSet(false);
      this.oldestAccessTime = 0;
    }
    ...
    public long getOldestAccessTime() {
      return this.oldestAccessTime;
    }

    /**
     * the last access time for the least significant block
     */
    public heartbeat_args setOldestAccessTime(long oldestAccessTime) {
      this.oldestAccessTime = oldestAccessTime;
      setOldestAccessTimeIsSet(true);
      return this;
    }

    public void unsetOldestAccessTime() {
      __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __OLDESTACCESSTIME_ISSET_ID);
    }

    /** Returns true if field oldestAccessTime is set (has been assigned a value) and false otherwise */
    public boolean isSetOldestAccessTime() {
      return EncodingUtils.testBit(__isset_bitfield, __OLDESTACCESSTIME_ISSET_ID);
    }

    public void setOldestAccessTimeIsSet(boolean value) {
      __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __OLDESTACCESSTIME_ISSET_ID, value);
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case OLDEST_ACCESS_TIME:
        if (value == null) {
          unsetOldestAccessTime();
        } else {
          setOldestAccessTime((Long)value);
        }
        break;
    ...
    public Object getFieldValue(_Fields field) {
      ...
      case OLDEST_ACCESS_TIME:
        return Long.valueOf(getOldestAccessTime());
    ...
    public boolean equals(heartbeat_args that) {
      ...
      boolean this_present_oldestAccessTime = true;
      boolean that_present_oldestAccessTime = true;
      if (this_present_oldestAccessTime || that_present_oldestAccessTime) {
        if (!(this_present_oldestAccessTime && that_present_oldestAccessTime))
          return false;
        if (this.oldestAccessTime != that.oldestAccessTime)
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_oldestAccessTime = true;
      list.add(present_oldestAccessTime);
      if (present_oldestAccessTime)
        list.add(oldestAccessTime);
    ...
    public int compareTo(heartbeat_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetOldestAccessTime()).compareTo(other.isSetOldestAccessTime());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetOldestAccessTime()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.oldestAccessTime, other.oldestAccessTime);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("oldestAccessTime:");
      sb.append(this.oldestAccessTime);
      first = false;
      sb.append(")");
      return sb.toString();
    }
    ...
    private static class heartbeat_argsStandardScheme extends StandardScheme<heartbeat_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, heartbeat_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            ...
            case 5: // OLDEST_ACCESS_TIME
              if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
                struct.oldestAccessTime = iprot.readI64();
                struct.setOldestAccessTimeIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, heartbeat_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeFieldBegin(OLDEST_ACCESS_TIME_FIELD_DESC);
        oprot.writeI64(struct.oldestAccessTime);
        oprot.writeFieldEnd();
        oprot.writeFieldStop();
        oprot.writeStructEnd();
      }
    ...
    private static class heartbeat_argsTupleScheme extends TupleScheme<heartbeat_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, heartbeat_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetOldestAccessTime()) {
          optionals.set(4);
        }
        oprot.writeBitSet(optionals, 5);
        if (struct.isSetWorkerId()) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<WorkerInfo>(_list90.size);
                  WorkerInfo _elem91;
                  for (int _i92 = 0; _i92 < _list90.size; ++_i92)
                  {
                    _elem91 = new WorkerInfo();
                    _elem91.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getWorkerInfoList_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (WorkerInfo _iter93 : struct.success)
            {
              _iter93.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (WorkerInfo _iter94 : struct.success)
            {
              _iter94.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<WorkerInfo>(_list95.size);
            WorkerInfo _elem96;
            for (int _i97 = 0; _i97 < _list95.size; ++_i97)
            {
              _elem96 = new WorkerInfo();
              _elem96.read(iprot);
