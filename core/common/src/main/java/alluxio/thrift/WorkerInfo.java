...
public class WorkerInfo implements org.apache.thrift.TBase<WorkerInfo, WorkerInfo._Fields>, java.io.Serializable, Cloneable, Comparable<WorkerInfo> {
  ...
  private static final org.apache.thrift.protocol.TField OLDEST_BLOCK_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("oldestBlockTime", org.apache.thrift.protocol.TType.I64, (short)8);
  ...
  private long oldestBlockTime; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    OLDEST_BLOCK_TIME((short)8, "oldestBlockTime");
  ...
  private static final int __OLDESTBLOCKTIME_ISSET_ID = 5;
  ...
  static {
    ...
    tmpMap.put(_Fields.START_TIME_MS, new org.apache.thrift.meta_data.FieldMetaData("startTimeMs", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.OLDEST_BLOCK_TIME, new org.apache.thrift.meta_data.FieldMetaData("oldestBlockTime", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    ...
    long oldestBlockTime)
  {
    ...
    this.oldestBlockTime = oldestBlockTime;
    setOldestBlockTimeIsSet(true);
  }
  ...
  public WorkerInfo(WorkerInfo other) {
    ...
    this.oldestBlockTime = other.oldestBlockTime;
  }
  ...
  public void clear() {
    ...
    this.startTimeMs = 0;
    setOldestBlockTimeIsSet(false);
    this.oldestBlockTime = 0;
  }
  ...
  public long getOldestBlockTime() {
    return this.oldestBlockTime;
  }

  public WorkerInfo setOldestBlockTime(long oldestBlockTime) {
    this.oldestBlockTime = oldestBlockTime;
    setOldestBlockTimeIsSet(true);
    return this;
  }

  public void unsetOldestBlockTime() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __OLDESTBLOCKTIME_ISSET_ID);
  }

  /** Returns true if field oldestBlockTime is set (has been assigned a value) and false otherwise */
  public boolean isSetOldestBlockTime() {
    return EncodingUtils.testBit(__isset_bitfield, __OLDESTBLOCKTIME_ISSET_ID);
  }

  public void setOldestBlockTimeIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __OLDESTBLOCKTIME_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case OLDEST_BLOCK_TIME:
      if (value == null) {
        unsetOldestBlockTime();
      } else {
        setOldestBlockTime((Long)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case OLDEST_BLOCK_TIME:
      return Long.valueOf(getOldestBlockTime());
  ...
  public boolean equals(WorkerInfo that) {
    ...
    boolean this_present_oldestBlockTime = true;
    boolean that_present_oldestBlockTime = true;
    if (this_present_oldestBlockTime || that_present_oldestBlockTime) {
      if (!(this_present_oldestBlockTime && that_present_oldestBlockTime))
        return false;
      if (this.oldestBlockTime != that.oldestBlockTime)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_oldestBlockTime = true;
    list.add(present_oldestBlockTime);
    if (present_oldestBlockTime)
      list.add(oldestBlockTime);
  ...
  public int compareTo(WorkerInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetOldestBlockTime()).compareTo(other.isSetOldestBlockTime());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOldestBlockTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.oldestBlockTime, other.oldestBlockTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("oldestBlockTime:");
    sb.append(this.oldestBlockTime);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  private static class WorkerInfoStandardScheme extends StandardScheme<WorkerInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, WorkerInfo struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // OLDEST_BLOCK_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.oldestBlockTime = iprot.readI64();
              struct.setOldestBlockTimeIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorkerInfo struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(OLDEST_BLOCK_TIME_FIELD_DESC);
      oprot.writeI64(struct.oldestBlockTime);
      oprot.writeFieldEnd();
  ...
  private static class WorkerInfoTupleScheme extends TupleScheme<WorkerInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, WorkerInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOldestBlockTime()) {
        optionals.set(7);
      }
