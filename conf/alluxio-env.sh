...
export ALLUXIO_MASTER_ADDRESS=${ALLUXIO_MASTER_ADDRESS:-172.28.128.3}
#export ALLUXIO_MASTER_ADDRESS=${ALLUXIO_MASTER_ADDRESS:-localhost}
export ALLUXIO_UNDERFS_ADDRESS=${ALLUXIO_UNDERFS_ADDRESS:-/tmp}
...
export ALLUXIO_WORKER_MEMORY_SIZE=${ALLUXIO_WORKER_MEMORY_SIZE:-400MB}
